// Owner-only note editor. Auth lives in URL fragment (#t=<edit-token>); we
// never put the token in the document so server logs / referrers never see
// it. The page fetches /raw to seed the textarea, then PUTs new content
// back via GET /?edit=<token>&c=...
